...
const ProductListCard = ({ product }) => {
  ...
  const Tooltip = ({ text, show }) => (
    <div
      ...
      } ${showQuantity ? "translate-x-[-108px]" : "translate-x-0"}`}
    >
  ...
  return (
    <div className="flex gap-4 sm:gap-6 md:gap-8 lg:gap-12">
      ...
      >
        ...
        {/* Hovered icons */}
        {isHovered && (
          <div className=" absolute  top-6 right-4 flex flex-col gap-2 z-20 transition-transform duration-500 animate-fade-in-up">
                ...
                >
                  ...
                  {showQuantity && (
                    <div
                      ...
                      className={`absolute -left-28 pl-14 flex items-center bg-white rounded-full shadow-md overflow-hidden transition-all duration-300 ease-in-out ${
                        showQuantity
