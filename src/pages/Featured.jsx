...
const Featured = () => {
  return (
    <div className="flex flex-col self-start items-start ml-12 justify-center text-2xl h-screen">
      <h1 className="text-4xl">home page</h1>
      <p>created only modern homepage other 5 is pending</p>
      <p>few issue in creating show all </p>
      <hr className="border-2 border-black my-4 w-1/2" />
      <h1 className="text-4xl">shop page</h1>
      <p>in price bar min price is not working</p>
      <p>few issue in color filter & also add all product color</p>
      <hr className="border-2 border-black my-4 w-1/2" />
