      ...
      >
        ...
        >
          ...
          <div className="relative">
            ...
            {cart.length > 0 && (
              <div className="absolute -right-6 top-6 mt-4 z-50 bg-white text-black border border-gray-200 w-[350px] shadow-xl h-[80vh]">
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            <p className="text-gray-500 text-xs font-poppins">
                              ...
                              {item.product.discountPrice
                                ...
                                : (
                                   item.product.orignalPrice * item.quantity
                                  ).toFixed(2)}
                            </p>
                            {/* quantity button*/}
